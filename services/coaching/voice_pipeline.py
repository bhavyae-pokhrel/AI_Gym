...
class VoicePipeline:
    ...
    def _find_form_issue(self, exercise, metrics):
        try:
            ...
            if exercise == "Squats":
                ...
                if swing == "SWINGING":
                    print("The user is swinging their torso during the curl — keep the body still.")
                    return "The user is swinging their torso during the curl — keep the body still."

                if shoulder == "ELBOW DRIFTING":
                    print("The user's elbow is drifting away from their side during the curl.")
            ...
            print("voice_pipeline _find_form_issue function run successfully")
    ...
    def process_event(self, event, exercise, metrics):
        try:
            ...
            print(f"Error in voice_pipeline process_event function: {e}")
...
def autoplay_audio(audio_bytes):
    try:
        ...
        print(f"Error in voice_pipeline autoplay_audio function: {e}")