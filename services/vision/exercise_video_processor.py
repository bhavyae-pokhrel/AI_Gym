...
from mediapipe.tasks import python #! MediaPipe have a module called python, python module contains the Python-specific API.
...
class VideoProcessorClass(VideoProcessorBase):
    def __init__(self):
        ...
        options = vision.PoseLandmarkerOptions(
            ...
            output_segmentation_masks=False #!segmentation mask is an image where each pixel tells you which object or region it belongs to
        )

        self._landmarker = vision.PoseLandmarker.create_from_options(options) #! creates the pose detector using those settings.
